			...
			<div class="row">
					...
					<div class="card">
						<div class="card-header pb-0">
							<div class="d-flex align-items-center">
								...
								<a href="case-new.html" class="btn btn-primary btn-sm ms-auto">Edit</a>
							</div>
						</div>
						<div class="card-body">
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4">
									...
									<p class="text-sm mb-3">01/11/2025</p>
								</div>
								<div class="col-md-4">
									<p class="text-xs text-uppercase text-muted mb-1">Expected Completion</p>
									<p class="text-sm mb-3">30/11/2025</p>
								</div>
								<div class="col-md-4">
									<p class="text-xs text-uppercase text-muted mb-1">Total Fees</p>
									<p class="text-sm mb-3">$2,500</p>
								</div>
							</div>
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" data-bs-toggle="tab" href="#tasks" role="tab">Tasks</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" data-bs-toggle="tab" href="#finance" role="tab">Finance</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" data-bs-toggle="tab" href="#documents" role="tab">Documents</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" data-bs-toggle="tab" href="#notes" role="tab">Notes</a>
								</li>
							</ul>
							<div class="tab-content pt-3">
								<div class="tab-pane active" id="timeline" role="tabpanel">
									<ul class="list-group">
										<li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
											<div class="d-flex align-items-center">
												<div class="icon icon-shape icon-sm me-3 bg-gradient-dark shadow text-center"><i class="ni ni-time-alarm text-white opacity-10"></i></div>
												<div class="d-flex flex-column">
													<h6 class="mb-1 text-dark text-sm">Hearing Scheduled</h6>
													<span class="text-xs">12 Nov 2025, 10:00 AM</span>
												</div>
											</div>
										</li>
										<li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
											<div class="d-flex align-items-center">
												<div class="icon icon-shape icon-sm me-3 bg-gradient-info shadow text-center"><i class="ni ni-folder-17 text-white opacity-10"></i></div>
												<div class="d-flex flex-column">
													<h6 class="mb-1 text-dark text-sm">Affidavit Uploaded</h6>
													<span class="text-xs">10 Nov 2025</span>
												</div>
											</div>
										</li>
									</ul>
								...
								<div class="tab-pane" id="notes" role="tabpanel">
									<textarea class="form-control" rows="4" placeholder="Add private notes..."></textarea>
									<button class="btn btn-sm btn-dark mt-2">Save Notes</button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-4">
					<div class="card">
						...
						<div class="card-body">
							<a href="documents.html" class="btn btn-outline-dark w-100 mb-2">Generate Legal Document</a>
							<a href="appointments.html" class="btn btn-outline-dark w-100 mb-2">Book Appointment</a>
							<a href="billing.html" class="btn btn-outline-dark w-100">Record Payment</a>
						</div>
					</div>
				</div>
			</div>
